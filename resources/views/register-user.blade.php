    ...
    <div class="container"><br>
        <div class="col-md-6 col-md-offset-3">
            ...
            @csrf
                ...
                <div class="form-group">
                    <label>Nrp</label>
                    <input type="number" name="nrp" class="form-control" placeholder="nrp" required="">
                </div>
                <div class="form-group">
                ...
                <hr>
                <p class="text-center">Sudah punya akun silahkan <a href="/login-user">Login Disini!</a></p>
            </form>
        </div>
    </div>
</body>
